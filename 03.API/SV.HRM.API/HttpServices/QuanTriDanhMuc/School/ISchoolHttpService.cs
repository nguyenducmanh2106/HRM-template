...
namespace SV.HRM.API.HttpServices
{
    ...
    {
        Task<Response<List<SchoolModel>>> GetFilter(EntityGeneric queryFilter);
        ...
        /// <returns></returns>
        Task<Response<bool>> Create(SchoolCreateModel model);
        ...
        /// <returns></returns>
        Task<Response<SchoolModel>> FindById(int recordID);
        /// <summary>
        /// check bản ghi trong bảng School có đang được sử dụng hay không
        /// </summary>
        /// <param name="recordID">Id bản ghi cần lấy</param>
        /// <returns></returns>
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<Response<bool>> Update(int id, SchoolUpdateModel model);
    }
}
