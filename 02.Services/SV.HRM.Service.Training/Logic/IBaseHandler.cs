...
namespace SV.HRM.Service.Training
{
    public interface IBaseHandler
    {
        ...
        /// <param name="entityGeneric"></param>
        /// <returns></returns>
        Task<Response<T>> CreateObject<T>(string layout, T entityGeneric);
        ...
        /// <param name="entityGeneric"></param>
        /// <returns></returns>
        Task<Response<T>> UpdateObject<T>(string layout, int id, T entityGeneric);
        ...
        /// <param name="entityGeneric"></param>
        /// <returns></returns>
        Task<Response<List<T>>> GetFilterCategory<T>(EntityGeneric entityGeneric);
    }
}
