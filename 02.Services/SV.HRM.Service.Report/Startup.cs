...
using SV.HRM.Service.Report.Ioc;
using System;
...
namespace SV.HRM.Service.Report
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            LoggingBuilderExten.UseNLog(configFilePath, configuration.GetSection("Logging:KafkaTaget").Get<string>(), LogSourceTypeEnums.HRM_Service_Report);
