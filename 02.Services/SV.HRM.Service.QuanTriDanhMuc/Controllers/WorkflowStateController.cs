...
namespace SV.HRM.Service.QuanTriDanhMuc.Controllers
{
    ...
    {
        private readonly IWorkflowStateHandler _workflowStateHandler;
        private readonly IBaseHandler _baseHandler;

        public WorkflowStateController(IBaseHandler baseHandler,
             IWorkflowStateHandler workflowStateHandler
            )
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<Response<bool>> Create([FromBody] WorkflowStateCreateModel entity)
        {
            return await _workflowStateHandler.Create(entity);
        }
        ...
        {
            return await _workflowStateHandler.FindById(recordID);
        }
        ...
        {
            return await _baseHandler.DeleteMany<WorkflowState>(entity);
        }
        ...
        {
            return await _workflowStateHandler.CheckRecordInUse(entity);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<Response<bool>> Update(Guid id, [FromBody] WorkflowStateUpdateModel entity)
        {
            return await _workflowStateHandler.Update(id, entity);
        }
    }
}
