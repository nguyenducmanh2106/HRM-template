...
namespace SV.HRM.Service.QuanTriDanhMuc
{
    public interface IBaseHandler
    {
        ...
        /// <param name="recordID">Id cần xóa</param>
        /// <returns></returns>
        Task<Response<bool>> DeleteManyCheckUseRecordGuid<T>(List<object> recordID);
        ...
        /// <returns></returns>
        IEnumerable<OrganizationModel> GetListChildOrganizationAndOrganizationId(int organizationId);
