...
using SV.HRM.Service.ThongTinNhanSu.Ioc;
...
namespace SV.HRM.Service.ThongTinNhanSu
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            LoggingBuilderExten.UseNLog(configFilePath, configuration.GetSection("Logging:KafkaTaget").Get<string>(), LogSourceTypeEnums.HRM_Service_ThongTinNhanSu);
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v3",
                    Title = "API Service ThongTinNhanSu",
                    Description = "",
                });
            });
        }
