...
{
    public interface IRemindWorkHandler
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        List<StaffHistory> GetCurrentHistory();

        /// <summary>
        /// Lấy quá trình tăng cường hiện tại
        /// </summary>
        /// <returns></returns>
        List<StaffHistory> GetCurrentStrengthenHistory();

        /// <summary>
        /// Lấy hợp đồng hiện tại
        /// </summary>
        /// <returns></returns>
        List<StaffLabourContract> GetCurrentContract();

        /// <summary>
        /// Lấy quá trình lương hiện tại
        /// </summary>
        /// <returns></returns>
        List<StaffSalary> GetCurrentSalary();
        #endregion;
        ...
        /// <returns></returns>
        Task<Response<bool>> DeleteMany(List<int> recordIds);
