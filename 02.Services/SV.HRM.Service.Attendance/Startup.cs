...
using SV.HRM.Service.Attendance.Ioc;
...
namespace SV.HRM.Service.Attendance
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            LoggingBuilderExten.UseNLog(configFilePath, configuration.GetSection("Logging:KafkaTaget").Get<string>(), LogSourceTypeEnums.HRM_Service_Attendance);
