...
using SV.HRM.Service.LeaveManagement.Ioc;
...
namespace SV.HRM.Service.LeaveManagement
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            LoggingBuilderExten.UseNLog(configFilePath, configuration.GetSection("Logging:KafkaTaget").Get<string>(), LogSourceTypeEnums.HRM_Service_Leave_Management);
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v3",
                    Title = "API Service Leave Manangement",
                    Description = "",
                });
            });
        }
